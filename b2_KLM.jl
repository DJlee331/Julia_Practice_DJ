...
include("FFWD_Replicate_Main.jl")
include("b1_params.jl");
...
for it_PLM=1:maxitPLM
    ...
    include("b3_HJB.jl");                   # Solve the individual HJB given the PLM
    println("Simulation started. Total number of years : ",nval_Zsim*dt)
    include("b5_KFE.jl")                   # Simulate the path of the distribution and aggregate variables for the shocks
